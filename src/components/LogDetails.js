    ...
    if (props.show) {
        return (
            <div className="logDetailsContainer">
                ...
                <Label fontSize="1.9vh" color="#FFF" className="logDetailActual" bkg="#7000FF20" style={{ top: 'calc(43.59375% + (1 * 7%))', height: '6.09375%' }} text={localStorage.getItem('CIP') == props.logObj.ip ? 'This Device' : props.logObj.details.device[0].toString().toUpperCase() + props.logObj.details.device.toString().substring(1, props.logObj.details.device.toString().length)}></Label>
