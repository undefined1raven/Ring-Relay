    ...
    if (props.show) {
        return (
            <div>
                ...
                <Signature sig2="bbsqc.svg42" doubleSig={true} height="15%" sigLabel="Own Encryption Key" verified={'self'} valid={true} sig="xxsqc.svg42" top="80%"></Signature>
                <Signature sigLabel="Own SIG Verification Key" verified={'self'} valid={true} sig="xxxsq.sgf42" top="70%"></Signature>
