...
function AuthedMsgDeco(props) {
    return (
        <svg id={props.id} className="notAuthedMsgDeco" width="2.3vh" height="2.3vh" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="15" height="13" fill="#00FFD1" fillOpacity={props.bkgOpacity == undefined ? 0.3 : props.bkgOpacity} />
            <rect x="5.25" y="5.25" width="4.5" height="4.5" fill="#00FFD1" fillOpacity="0.2" stroke="#00FFD1" strokeWidth="0.5" />
