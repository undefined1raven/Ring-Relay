...
function WideLogo() {
    return (
        <svg style={{position: 'absolute', width: '100%', height: 'auto', borderBottom: 'solid 1px #6100DC'}} width="360" height="101" viewBox="0 0 360 101" fill="none" xmlns="http://www.w3.org/2000/svg" >
            ...
            <path d="M183.543 51.0977C183.543 58.8173 176.839 65.1855 168.43 65.1855C160.02 65.1855 153.316 58.8173 153.316 51.0977C153.316 43.378 160.02 37.0098 168.43 37.0098C176.839 37.0098 183.543 43.378 183.543 51.0977Z" stroke="#6100DC" strokeWidth="2" />
            <defs>
                <linearGradient id="paint0_linear_6_59" x1="229.219" y1="99.6924" x2="214.475" y2="19.4383" gradientUnits="userSpaceOnUse">
                    ...
                    <stop offset="0.493013" stopColor="#6100DC" stopOpacity="0.671721" />
                    <stop offset="1" stopColor="#6100DC" stopOpacity="0.5" />
                </linearGradient>
            </defs>
        </svg >
    )
