...
function SettingsLogs(props) {
    ...
    const [logsArray, setLogsArray] = useState({
        ini: true, array: [
            ...
            { severity: 'critical', type: 'Security', subtype: 'Private Key Export', tx: Date.now(), ip: '190.15.32.51', location: { name: 'Aiur City', coords: { lat: 0, long: 0 } }, details: { exportType: 'scan', device: 'iPhone 12', browser: 'Chrome v102', os: 'iOS 16' } },
            { severity: 'critical', type: 'Security', subtype: 'Private Key Export', tx: Date.now(), ip: '190.15.32.51', location: { name: 'Aiur City', coords: { lat: 0, long: 0 } }, details: { exportType: 'scan', device: 'iPhone 12', browser: 'Chrome v102', os: 'iOS 16' } },
            ...
            { severity: 'critical', type: 'Security', subtype: 'Private Key Import', tx: Date.now(), ip: '190.15.32.51', location: { name: 'Aiur City', coords: { lat: 0, long: 0 } }, details: { importType: 'scan', device: 'iPhone 12', browser: 'Chrome v102', os: 'iOS 16' } },
