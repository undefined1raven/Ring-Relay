    ...
    if (props.show) {
        return (
            <div className="locationMsgTypePreviewContainer" style={{ backgroundColor: props.bkg }}>
                ...
                <Label style={{ top: '15%', left: '23%' }} fontSize="2.1vh" text={props.selectedImage.ini && props.selectedImage.fileName ? `${props.selectedImage.fileName}` : 'No File Selected'} color="#FFF"></Label>
