...
function NavBar() {
    ...
    return (
        <div className="navBarContainer">
            ...
            <Button id="chatsNavButton" fontSize="2.12vh" className="navButton" color={navButtonBkgController('chats')} width="20.555555556%" height="100%" label="Chats"></Button>
            <Button id="newContactNavButton" fontSize="2.12vh" className="navButton" color={navButtonBkgController('newContact')} width="20.555555556%" height="100%" label="New Contact"></Button>
            <Button id="settingsNavButton" fontSize="2.12vh" className="navButton" color={navButtonBkgController('settings')} width="20.555555556%" height="100%" label="Settings"></Button>
