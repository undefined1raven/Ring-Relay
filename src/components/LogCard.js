...
function LogCard(props) {
    ...
    return (
        <div className="logCardContainer" style={{ backgroundColor: colorController().bkg }}>
            ...
            <Label style={{ top: '10.256410256%', left: '69.75308642%', width: '28.395061728%', textAlign: 'end', paddingRight: '2%' }} fontSize="1.9vh" color={colorController().primary} text={props.logObj.location}></Label>
