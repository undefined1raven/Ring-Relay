    ...
    if (props.show) {
        return (
            <div>
                ...
                <LoadingNewDeco top={props.refs.ini ? '40%' : '20%'} show={!props.refs.ini} fillOpacity={props.refs.ini ? 0.03 : 0.2} strokeWidth={props.refs.ini ? 0 : 0.5} width="40vh" height="30vh" id="chatsFetchingDeco" pathCN="chatsFetchingDecoElm"></LoadingNewDeco>
            </div>
        )
    } else {
        return ''
